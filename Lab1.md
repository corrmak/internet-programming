...
2. Обновите пакетный менеджер внутри контейнера:
   apk update
...
## Заключение
Эта лабораторная работа включает базовую установку Docker,создание автоматизированного установочного скрипта и использование Docker внутри образа alpine. Полученные знания помогут в будущих лабораторных заданиях.
